        ...
        return (
            <Row className="p-3 wishlistLogin">
                <Col md={{ span: 12 }}>
                    ...
                    <div className="wishlistLogin-icon"><i className="far fa-bookmark"></i></div>
                    <Link to="login">
        ...
        return (
            <Row className="p-3 wishlistLogin">
                <Col md={{ span: 12 }}>
                    ...
                    <div className="wishlistLogin-info">Add items that you like to your wishlist. Review them anytime and easily move them to the bag.</div>
                    <div className="wishlistLogin-icon"><i className="far fa-bookmark"></i></div>
                    <Link to="/">
                        <Button variant="primary" size="lg" block>CONTINUE SHOPPING</Button>
                    </Link>
                </Col>
            </Row>
        )
